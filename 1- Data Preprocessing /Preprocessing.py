...
# We encode categorical data using one hot encoder to prevent our model from mis-interpreting some co-relations
# between different numbers in the same column, the model will misunderstand the data to be in some kind of order
